...
def plot_runtimes_powerlaw(prefix):
    ...
    plt.ylabel("Time (ns)")
    plt.legend(["Top Down (Seq)", "Top Down (Par)", "Bottom Up (Seq)", "Bottom Up (Par)", "Hybrid (Par)"])
    plt.title("BFS Runtimes on Random Powerlaw Graphs ($|V| = 20000$, $\mu_{deg} = 5$, $p = 0.25$)", fontsize=12)
...
def plot_runtimes_powerlaw2(prefix):
    ...
    plt.ylabel("Time (ns)")
    plt.legend(["Top Down (Seq)", "Top Down (Par)", "Bottom Up (Seq)", "Bottom Up (Par)", "Hybrid (Par)"])
    plt.title("BFS Runtimes on Random Powerlaw Graphs ($|V| = 20000$, $\mu_{deg} = 10$, $p = 0.25$)", fontsize=12)
...
def plot_speedup_powerlaw(prefix):
    ...
    plt.xlabel("Number of Threads")
    plt.ylabel("Speedup")
    plt.title("BFS Speedup on Random Powerlaw Graphs ($|V| = 20000$, $\mu_{deg} = 5$, $p = 0.25$)", fontsize=12)
...
def plot_speedup_powerlaw2(prefix):
    ...
    plt.xlabel("Number of Threads")
    plt.ylabel("Speedup")
    plt.title("BFS Speedup on Random Powerlaw Graphs ($|V| = 20000$, $\mu_{deg} = 10$, $p = 0.25$)", fontsize=12)
    plt.legend(["Top Down", "Bottom Up", "Direction Optimizing", "Baseline"])
    plt.savefig("bfs_plots/bfs_powerlaw2_speedup.png", dpi=500)
    plt.show()
